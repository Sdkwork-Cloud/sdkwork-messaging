...
- `pnpm run test:messaging-contracts`: run the configured test suite for this scope.
- `pnpm run test:messaging-runtime`: run the configured test suite for this scope.
