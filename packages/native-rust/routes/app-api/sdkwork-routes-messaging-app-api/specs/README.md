...
This directory is the local SDKWork component contract for `sdkwork-routes-messaging-app-api`.

- Component root: `sdkwork-messaging/packages/native-rust/routes/app-api/sdkwork-routes-messaging-app-api`
