# sdkwork_messaging_storage_sqlx
...
This README is the SDKWork module entrypoint for `sdkwork_messaging_storage_sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-messaging/packages/native-rust/messaging/sdkwork-messaging-storage-sqlx-rust/Cargo.toml`
