...
This README is the SDKWork module entrypoint for `sdkwork_messaging_core`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-messaging/packages/native-rust/messaging/sdkwork-messaging-core-rust/Cargo.toml`
