# sdkwork_messaging_delivery_repository_sqlx
...
This README is the SDKWork module entrypoint for `sdkwork_messaging_delivery_repository_sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-messaging/crates/sdkwork-messaging-delivery-repository-sqlx/Cargo.toml`
