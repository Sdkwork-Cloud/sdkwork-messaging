...
This directory is the local standards index for `sdkwork_messaging_delivery_repository_sqlx`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_messaging_delivery_repository_sqlx` |
| Type | `rust-crate` |
| Root | `sdkwork-messaging/crates/sdkwork-messaging-delivery-repository-sqlx` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
