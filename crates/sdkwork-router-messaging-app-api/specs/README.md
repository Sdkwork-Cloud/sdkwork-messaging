...
This directory is the local SDKWork component contract for `sdkwork-router-messaging-app-api`.

- Component root: `sdkwork-messaging/crates/sdkwork-router-messaging-app-api`
