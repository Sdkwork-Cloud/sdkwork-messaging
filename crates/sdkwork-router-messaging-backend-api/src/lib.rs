...
pub fn messaging_backend_api_manifest() -> MessagingBackendRouteManifest {
    MessagingBackendRouteManifest {
        ...
        package_name: "sdkwork-router-messaging-backend-api",
        surface: "backend-api",
        ...
        routes: vec![
            ...
            route(
                ...
                "messaging_notifications_create",
                Some("MessagingNotificationCreateRequest"),
                "MessagingNotificationResponse",
                true,
            ),
            route(
                "GET",
            ...
            route(
                ...
                "messaging_announcements_publish",
                Some("MessagingAnnouncementPublishRequest"),
                "MessagingAnnouncementResponse",
                true,
            ),
            route(
                "GET",
                ...
                "messaging_push_messages_list",
                None,
                "MessagingPushMessageListResponse",
                false,
            ),
            route(
                "POST",
                ...
                "messaging_push_messages_send",
                Some("MessagingPushMessageSendRequest"),
                "MessagingPushMessageResponse",
                true,
            ),
            route(
                "GET",
                ...
                "messaging_outbound_messages_list",
                None,
            ...
            route(
                ...
                "messaging_outbound_messages_send",
                Some("MessagingOutboundMessageSendRequest"),
                "MessagingOutboundMessageResponse",
                true,
            ),
            route(
                "GET",
                ...
                "messaging_verification_policies_list",
                None,
            ...
            route(
                ...
                "messaging_verification_policies_update",
                Some("MessagingVerificationPolicyUpdateRequest"),
                "MessagingVerificationPolicyResponse",
                true,
            ),
        ],
    }
...
fn route(
    ...
    MessagingBackendRoute {
        ...
        source_route_crate: "sdkwork-router-messaging-backend-api",
    }
}
