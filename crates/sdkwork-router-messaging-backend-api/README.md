...
This README is the SDKWork module entrypoint for `sdkwork-router-messaging-backend-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../../sdkwork-specs/`.
