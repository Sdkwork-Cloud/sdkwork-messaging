...
This directory is the local standards index for `sdkwork_messaging_delivery_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork_messaging_delivery_service` |
| Type | `rust-crate` |
| Root | `sdkwork-messaging/crates/sdkwork-messaging-delivery-service` |
| Domain | `platform` |
| Capability | `app` |
| Languages | `rust` |
