# sdkwork_messaging_delivery_service
...
This README is the SDKWork module entrypoint for `sdkwork_messaging_delivery_service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-messaging/crates/sdkwork-messaging-delivery-service/Cargo.toml`
