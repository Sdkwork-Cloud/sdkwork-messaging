...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_messaging_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'messaging_', owner: 'messaging-platform', domain: 'messaging' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into messaging database contract\n`);
