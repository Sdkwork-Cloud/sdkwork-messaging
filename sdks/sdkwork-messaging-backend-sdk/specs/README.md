...
This directory is the local SDKWork component contract for `sdkwork-messaging-backend-sdk`.

- Component root: `sdkwork-messaging/sdks/sdkwork-messaging-backend-sdk`
