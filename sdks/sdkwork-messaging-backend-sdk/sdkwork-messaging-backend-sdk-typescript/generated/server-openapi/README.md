...
```bash
npm install @sdkwork/messaging-backend-sdk
# or
yarn add @sdkwork/messaging-backend-sdk
# or
pnpm add @sdkwork/messaging-backend-sdk
```

## Quick Start

```typescript
import { SdkworkBackendClient } from '@sdkwork/messaging-backend-sdk';
...
const result = await client.messaging.notifications.list(params);
```
...
```typescript
import { SdkworkBackendClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/messaging-backend-sdk';
