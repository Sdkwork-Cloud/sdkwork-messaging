...
```bash
npm install @sdkwork/messaging-app-sdk
# or
yarn add @sdkwork/messaging-app-sdk
# or
pnpm add @sdkwork/messaging-app-sdk
```

## Quick Start

```typescript
import { SdkworkAppClient } from '@sdkwork/messaging-app-sdk';
...
```typescript
import { SdkworkAppClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/messaging-app-sdk';
